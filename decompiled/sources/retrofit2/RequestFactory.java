...
public final class RequestFactory {
    ...
    public static final class Builder {
        ...
        private ParameterHandler<?> parseParameter(int i, Type type, @Nullable Annotation[] annotationArr, boolean z) {
            ...
            if (parameterHandler == null) {
                if (z) {
                    try {
                        if (Utils.getRawType(type) == vt.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                if (this.isMultipart) {
                    ...
                    Headers of = Headers.of("Content-Disposition", l90.m("form-data; name=\"", value5, "\""), "Content-Transfer-Encoding", part.encoding());
                    if (Iterable.class.isAssignableFrom(rawType8)) {
                        if (type instanceof ParameterizedType) {
            ...
            if (annotation instanceof Tag) {
                ...
                for (int i2 = i - 1; i2 >= 0; i2--) {
                    ...
                    if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                        ...
                        sb.append(rawType10.getName());
                        sb.append(" is duplicate of ");
                        throw Utils.parameterError(method, i, l90.p(sb, Platform.reflection.describeMethodParameter(this.method, i2), " and would always overwrite its value."), new Object[0]);
                    }
                }
    ...
    public Request create(@Nullable Object obj, Object[] objArr) {
        ...
        StringBuilder q = l90.q("Argument count (", length, ") doesn't match expected count (");
        q.append(parameterHandlerArr.length);
        q.append(")");
