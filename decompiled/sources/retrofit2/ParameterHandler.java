...
public abstract class ParameterHandler<T> {
                ...
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        if (value != null) {
                            ...
                            throw Utils.parameterError(this.method, this.p, l90.m("Field map contained null value for key '", key, "'."), new Object[0]);
                        }
                    } else {
                ...
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        if (value != null) {
                            ...
                            throw Utils.parameterError(this.method, this.p, l90.m("Header map contained null value for key '", key, "'."), new Object[0]);
                        }
                    } else {
            ...
            if (map != null) {
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        T value = entry.getValue();
                        if (value != null) {
                            requestBuilder.addPart(okhttp3.Headers.of("Content-Disposition", l90.m("form-data; name=\"", key, "\""), "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            throw Utils.parameterError(this.method, this.p, l90.m("Part map contained null value for key '", key, "'."), new Object[0]);
                        }
                    } else {
    ...
    public static final class Path<T> extends ParameterHandler<T> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable T t) {
            ...
            throw Utils.parameterError(this.method, this.p, l90.p(new StringBuilder("Path parameter \""), this.name, "\" value must not be null."), new Object[0]);
        }
    }
                ...
                for (Map.Entry<String, T> entry : map.entrySet()) {
                    ...
                    if (key != null) {
                        ...
                        if (value != null) {
                            ...
                            throw Utils.parameterError(this.method, this.p, l90.m("Query map contained null value for key '", key, "'."), new Object[0]);
                        }
                    } else {
