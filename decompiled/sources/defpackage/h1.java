...
public final class h1 {
    ...
    public h1(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (i != 1) {
            if (i != 2) {
                switch (i) {
                    ...
                    case SharedConstants.DefaultBufferSize /* 8192 */:
    ...
    public final CharSequence e() {
        ...
        if (!isEmpty) {
            ...
            for (int i = 0; i < b.size(); i++) {
                spannableString.setSpan(new t0(((Integer) b4.get(i)).intValue(), this, accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) b.get(i)).intValue(), ((Integer) b2.get(i)).intValue(), ((Integer) b3.get(i)).intValue());
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.c == h1Var.c && this.b == h1Var.b) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        if (i3 >= 34) {
            w0.b(accessibilityNodeInfo, rect);
        } else {
        ...
        if (i3 >= 36) {
            charSequence = g1.c(accessibilityNodeInfo);
        } else {
        ...
        sb.append("; uniqueId: ");
        if (i3 >= 33) {
            string = f1.e(accessibilityNodeInfo);
        } else {
        ...
        if (i3 >= 34) {
            charSequence2 = w0.c(accessibilityNodeInfo);
        } else {
        ...
        sb.append(d(FileSystemManager.MODE_TRUNCATE));
