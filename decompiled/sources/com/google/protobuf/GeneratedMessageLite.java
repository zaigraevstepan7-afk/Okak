...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
        ...
        public GeneratedExtension(ContainingType containingtype, Type type, MessageLite messageLite, ExtensionDescriptor extensionDescriptor, Class cls) {
            if (containingtype != null) {
                if (extensionDescriptor.getLiteType() == WireFormat.FieldType.MESSAGE && messageLite == null) {
                    se.h("Null messageDefaultInstance");
                    throw null;
                }
            ...
            se.h("Null containingTypeDefaultInstance");
            throw null;
        }
    ...
    public static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            try {
                ...
                MessageLite.Builder newBuilderForType = ((MessageLite) declaredField.get(null)).newBuilderForType();
    ...
    public static <MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>, T> GeneratedExtension<MessageType, T> checkIsLite(ExtensionLite<MessageType, T> extensionLite) {
        ...
        se.h("Expected a lite extension.");
        return null;
    }
    ...
    public static final <T extends GeneratedMessageLite<T, ?>> boolean isInitialized(T t, boolean z) {
        Object obj;
        byte byteValue = ((Byte) t.dynamicMethod(MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED, null, null)).byteValue();
        if (byteValue == 1) {
            return true;
        }
        if (byteValue == 0) {
        ...
        if (z) {
            ...
            t.dynamicMethod(methodToInvoke, obj, null);
        }
    ...
    public int getSerializedSize(Schema schema) {
        if (isMutable()) {
            ...
            se.p(l90.g(computeSerializedSize, "serialized size must be non-negative, was "));
            return 0;
        }
    ...
    public void setMemoizedSerializedSize(int i) {
        if (i >= 0) {
            ...
            se.p(l90.g(i, "serialized size must be non-negative, was "));
        }
    }

    @Override // com.google.protobuf.MessageLite
    public final BuilderType toBuilder() {
        return (BuilderType) ((Builder) dynamicMethod(MethodToInvoke.NEW_BUILDER, null, null)).mergeFrom((Builder) this);
    }
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        public Builder(MessageType messagetype) {
            ...
            if (!messagetype.isMutable()) {
                ...
                se.h("Default instance must be immutable.");
                throw null;
            }
        }
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            if (fieldSet.isImmutable()) {
                FieldSet<ExtensionDescriptor> m38clone = fieldSet.m38clone();
                ((ExtendableMessage) this.instance).extensions = m38clone;
                return m38clone;
            }
            return fieldSet;
        }
        ...
        private void verifyExtensionContainingType(GeneratedExtension<MessageType, ?> generatedExtension) {
            ...
            se.h("This extension is for a different message type.  Please make sure that you are not suppressing any generics type warnings.");
        }
        ...
        public void copyOnWriteInternal() {
            ...
            if (((ExtendableMessage) this.instance).extensions != FieldSet.emptySet()) {
                MessageType messagetype = this.instance;
                ((ExtendableMessage) messagetype).extensions = ((ExtendableMessage) messagetype).extensions.m38clone();
            }
        }
        ...
        private <MessageType2 extends MessageLite> void mergeMessageSetExtensionFromCodedStream(MessageType2 messagetype2, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) {
            ...
            while (true) {
                ...
                if (readTag == WireFormat.MESSAGE_SET_TYPE_ID_TAG) {
                    ...
                    if (i != 0) {
                        generatedExtension = extensionRegistryLite.findLiteExtensionByNumber(messagetype2, i);
                    }
        ...
        */
        ...
        public <MessageType2 extends MessageLite> boolean parseUnknownFieldAsMessageSet(MessageType2 messagetype2, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, int i) {
            ...
            if (WireFormat.getTagWireType(i) == 2) {
                return parseUnknownField(messagetype2, codedInputStream, extensionRegistryLite, i);
            }
