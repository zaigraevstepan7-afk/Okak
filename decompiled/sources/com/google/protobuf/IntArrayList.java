...
public final class IntArrayList extends AbstractProtobufList<Integer> implements Internal.IntList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    */
    public IntArrayList(com.google.protobuf.IntArrayList r3, boolean r4) {
        /*
            r2 = this;
            int r0 = r3.size
            if (r0 != 0) goto L7
            int[] r0 = com.google.protobuf.IntArrayList.EMPTY_ARRAY
            goto Ld
        L7:
            int[] r1 = r3.array
        ...
        Ld:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.IntArrayList.<init>(com.google.protobuf.IntArrayList, boolean):void");
    }
    ...
    public Internal.ProtobufList<Integer> mutableCopyWithCapacity2(int i) {
        ...
        if (i >= this.size) {
            ...
            return new IntArrayList(copyOf, this.size, true);
        }
