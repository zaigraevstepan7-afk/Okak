...
public final class DoubleArrayList extends AbstractProtobufList<Double> implements Internal.DoubleList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    */
    public DoubleArrayList(com.google.protobuf.DoubleArrayList r3, boolean r4) {
        /*
            r2 = this;
            int r0 = r3.size
            if (r0 != 0) goto L7
            double[] r0 = com.google.protobuf.DoubleArrayList.EMPTY_ARRAY
            goto Ld
        L7:
            double[] r1 = r3.array
            double[] r0 = java.util.Arrays.copyOf(r1, r0)
        Ld:
            int r3 = r3.size
            r2.<init>(r0, r3, r4)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.DoubleArrayList.<init>(com.google.protobuf.DoubleArrayList, boolean):void");
    }
    ...
    public Internal.ProtobufList<Double> mutableCopyWithCapacity2(int i) {
        ...
        if (i >= this.size) {
            ...
            return new DoubleArrayList(copyOf, this.size, true);
        }
