...
public final class MethodOptionsKtKt {
    ...
    public static final DescriptorProtos.MethodOptions copy(DescriptorProtos.MethodOptions methodOptions, oe0 oe0Var) {
        methodOptions.getClass();
        oe0Var.getClass();
        MethodOptionsKt.Dsl.Companion companion = MethodOptionsKt.Dsl.INSTANCE;
        BuilderType builder = methodOptions.toBuilder();
        builder.getClass();
        MethodOptionsKt.Dsl _create = companion._create((DescriptorProtos.MethodOptions.Builder) builder);
        oe0Var.invoke(_create);
        return _create._build();
    }
    ...
    public static final DescriptorProtos.FeatureSet getFeaturesOrNull(DescriptorProtos.MethodOptionsOrBuilder methodOptionsOrBuilder) {
        methodOptionsOrBuilder.getClass();
