...
public final class ServiceDescriptorProtoKtKt {
    ...
    public static final DescriptorProtos.ServiceDescriptorProto m63initializeserviceDescriptorProto(oe0 oe0Var) {
        oe0Var.getClass();
    ...
    public static final DescriptorProtos.ServiceDescriptorProto copy(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, oe0 oe0Var) {
    ...
    public static final DescriptorProtos.ServiceOptions getOptionsOrNull(DescriptorProtos.ServiceDescriptorProtoOrBuilder serviceDescriptorProtoOrBuilder) {
        serviceDescriptorProtoOrBuilder.getClass();
