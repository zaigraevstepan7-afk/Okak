...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        public final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while (true) {
                    ...
                    this.position = i4 + 1;
                    UnsafeUtil.putByte(bArr, i4, (byte) (i | 128));
                    i >>>= 7;
                }
            } else {
                while (true) {
    ...
    public static int computeLazyFieldMessageSetExtensionSize(int i, LazyFieldLite lazyFieldLite) {
        return lazyFieldLite.computeMessageSetExtensionSize(i);
    }

    @Deprecated
    public static int computeLazyFieldSize(int i, LazyFieldLite lazyFieldLite) {
        return lazyFieldLite.computeSize(i);
    }

    @Deprecated
    public static int computeLazyFieldSizeNoTag(LazyFieldLite lazyFieldLite) {
        return lazyFieldLite.computeSizeNoTag();
    }
    ...
    public final void checkNoSpaceLeft() {
        ...
        se.p("Did not write as much data as expected.");
    }
    ...
    public static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void write(ByteBuffer byteBuffer) {
            ...
            try {
                ...
                throw new OutOfSpaceException(this.position, this.limit, remaining, (Throwable) e);
            }
        }
        ...
        public final void writeUInt64NoTag(long j) {
            ...
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while (true) {
                    ...
                    UnsafeUtil.putByte(bArr2, i2, (byte) (((int) j) | 128));
                    j >>>= 7;
                    i2++;
                }
                i = i2 + 1;
    ...
    public static final class UnsafeDirectNioEncoder extends CodedOutputStream {
            ...
            if (j3 <= this.oneVarintLimit) {
                ...
                while (true) {
                    ...
                    if (j6 < j8) {
                        ...
                        throw new OutOfSpaceException(j6, j8, 1);
                    }
                }
            }
            this.position = j2;
        ...
        public void write(byte b) {
            ...
            throw new OutOfSpaceException(j, j2, 1);
        }
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        public OutOfSpaceException(String str) {
            super(l90.l("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str));
        }
        ...
        public OutOfSpaceException(String str, Throwable th) {
            super(l90.l("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }
    ...
    public static CodedOutputStream newInstance(ByteOutput byteOutput, int i) {
        ...
        se.h("bufferSize must be positive");
        return null;
    }
}
