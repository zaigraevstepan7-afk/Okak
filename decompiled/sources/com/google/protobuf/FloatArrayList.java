...
public final class FloatArrayList extends AbstractProtobufList<Float> implements Internal.FloatList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    */
    public FloatArrayList(com.google.protobuf.FloatArrayList r3, boolean r4) {
        /*
            r2 = this;
            int r0 = r3.size
            if (r0 != 0) goto L7
            float[] r0 = com.google.protobuf.FloatArrayList.EMPTY_ARRAY
            goto Ld
        L7:
            float[] r1 = r3.array
        ...
        Ld:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.FloatArrayList.<init>(com.google.protobuf.FloatArrayList, boolean):void");
    }
    ...
    public Internal.ProtobufList<Float> mutableCopyWithCapacity2(int i) {
        ...
        if (i >= this.size) {
            ...
            return new FloatArrayList(copyOf, this.size, true);
        }
