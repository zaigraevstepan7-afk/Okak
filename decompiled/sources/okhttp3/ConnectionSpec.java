...
public final class ConnectionSpec {
    ...
    static {
        ...
        List<CipherSuite> F = xn.F(cipherSuite, cipherSuite2, cipherSuite3, cipherSuite4, cipherSuite5, cipherSuite6, cipherSuite7, cipherSuite8, cipherSuite9);
        RESTRICTED_CIPHER_SUITES = F;
        List<CipherSuite> F2 = xn.F(cipherSuite, cipherSuite2, cipherSuite3, cipherSuite4, cipherSuite5, cipherSuite6, cipherSuite7, cipherSuite8, cipherSuite9, CipherSuite.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, CipherSuite.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA, CipherSuite.TLS_RSA_WITH_AES_128_GCM_SHA256, CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384, CipherSuite.TLS_RSA_WITH_AES_128_CBC_SHA, CipherSuite.TLS_RSA_WITH_AES_256_CBC_SHA, CipherSuite.TLS_RSA_WITH_3DES_EDE_CBC_SHA);
        APPROVED_CIPHER_SUITES = F2;
        Builder builder = new Builder(true);
        CipherSuite[] cipherSuiteArr = (CipherSuite[]) F.toArray(new CipherSuite[0]);
        ...
        CipherSuite[] cipherSuiteArr2 = (CipherSuite[]) F2.toArray(new CipherSuite[0]);
        ...
        CipherSuite[] cipherSuiteArr3 = (CipherSuite[]) F2.toArray(new CipherSuite[0]);
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            enabledProtocols = _UtilCommonKt.intersect(enabledProtocols2, this.tlsVersionsAsString, c51.b);
        } else {
    ...
    public final List<CipherSuite> m159deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m161deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket socket) {
        ...
        if (strArr != null && !_UtilCommonKt.hasIntersection(strArr, socket.getEnabledProtocols(), c51.b)) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final Builder allEnabledCipherSuites() {
            ...
            se.h("no cipher suites for cleartext connections");
            return null;
        }
        ...
        public final Builder allEnabledTlsVersions() {
            ...
            se.h("no TLS versions for cleartext connections");
            return null;
        }
        ...
        public final Builder supportsTlsExtensions(boolean supportsTlsExtensions) {
            ...
            se.h("no TLS extensions for cleartext connections");
            return null;
        }
        ...
        public final Builder cipherSuites(String... cipherSuites) {
            ...
            if (this.tls) {
                ...
                se.h("At least one cipher suite is required");
                return null;
            }
            se.h("no cipher suites for cleartext connections");
            return null;
        ...
        public final Builder tlsVersions(String... tlsVersions) {
            ...
            if (this.tls) {
                ...
                se.h("At least one TLS version is required");
                return null;
            }
            se.h("no TLS versions for cleartext connections");
            return null;
