...
public abstract class Task {
    ...
    public final void initQueue$okhttp(TaskQueue queue) {
        ...
        if (taskQueue == null) {
            ...
            se.p("task is in multiple queues");
        }
    }
    ...
    public /* synthetic */ Task(String str, boolean z, int i, yx yxVar) {
