...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    private final boolean verifySignature(X509Certificate toVerify, X509Certificate signingCert, int minIntermediates) {
        if (!sn0.r(toVerify.getIssuerDN(), signingCert.getSubjectDN()) || signingCert.getBasicConstraints() < minIntermediates) {
            return false;
        }
        try {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BasicCertificateChainCleaner) && sn0.r(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex)) {
            return true;
        }
        return false;
    }
