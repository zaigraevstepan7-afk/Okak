...
public final class RealInterceptorChain implements Interceptor.Chain {
        ...
        if (this.index < this.interceptors.size()) {
            ...
            if (exchange != null) {
                if (exchange.getFinder().getRoutePlanner().sameHostAndPort(request.url())) {
                    if (this.calls != 1) {
                        y61.n("network interceptor ", this.interceptors.get(this.index - 1), " must call proceed() exactly once");
                        return null;
                    }
                } else {
                    y61.n("network interceptor ", this.interceptors.get(this.index - 1), " must retain the same host and port");
                    return null;
                }
            }
            ...
            if (intercept != null) {
                if (this.exchange != null && this.index + 1 < this.interceptors.size() && copy$okhttp$default.calls != 1) {
                    y61.n("network interceptor ", interceptor, " must call proceed() exactly once");
                    return null;
                }
                return intercept;
            }
    ...
    public Interceptor.Chain withConnectTimeout(int timeout, TimeUnit unit) {
        ...
        se.p("Timeouts can't be adjusted in a network interceptor");
        return null;
    }
